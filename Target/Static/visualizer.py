...
def plot_throughput_vs_time(csv_file='static_log.csv'):
    """
    ...
    plt.savefig('static_throughput_plot.png')  # Simpan sebagai PNG
    print("Plot saved as static_throughput_plot.png")  # Konfirmasi
